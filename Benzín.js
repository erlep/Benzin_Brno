...
//><span itemprop="price" content="33.90">33,90 Kč</span><meta content="CZK"
...
// =============================================================================
// Rothbury - https://rothbury.cz/cerpaci-stanice/verejna-cerpaci-stanice-olomoucka-brno
// https://www.facebook.com/tankovacimat   - Natural 28,79 Kč/L
function g_Rothbury2(){
  ...
  // 95\:[^]*?tr
  var regExp = new RegExp('natural.*Kč', 'i');
